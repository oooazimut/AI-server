...
def _decision_system_prompt(instructions: str = "") -> str:
    ...
    return (
        ...
        "When task_create_draft has no explicit group_id/project_name, the backend selects the personal project of the resolved responsible user. "
        "For a named responsible user always pass both the exact responsible_id and responsible_name returned by user.search. "
        "An explicit project always overrides that default. "
